...
namespace quanlykhachsan
{
    public partial class frmmain : Form
    {
        ...
        private void dtgvDanhSachphong_CellClick(object sender, DataGridViewCellEventArgs e)
        {
        ...
        private void dgtraphong_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            DataGridViewRow row = new DataGridViewRow();
